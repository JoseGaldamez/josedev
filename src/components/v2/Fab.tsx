...
export const Fab = ({ show = false, setShow = (value) => { } }: Props) => {
    ...
    return (
        <div className="z-50 fixed bottom-4 right-4">
            <motion.button
                className="fixed bottom-4 right-4 bg-[#296973] rounded-full p-2 shadow-lg"
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: 50 }}
                        className="fixed bottom-20 right-4 max-w-sm md:max-w-lg w-5/6 md:w-full bg-[#296973] rounded-xl shadow-lg p-4"
                    >
