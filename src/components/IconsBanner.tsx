      ...
      <div style={{ position: 'relative', zIndex: 10 }} className='w-full'>
        <div className='py-16 md:py-24 px-4'>
          ...
          <div className='text-center pt-16 max-w-2xl mx-auto text-white'>
            Entre otras tecnologías y herramientas como .Net, Docker, Kubernetes, Gemini, Antropic, Groq, MongoDB, PostgreSQL, SQLServer, NextJS, JWT Token, Ionic, Firebase, AWS, Google Cloud, etc.
          </div>
        </div>
      </div>
    </div>
