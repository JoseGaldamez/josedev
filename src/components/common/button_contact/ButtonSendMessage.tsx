...
export const ButtonSendMessage = ({ sendMessage, sending }: IButtonSendContact) => {
    ...
    return (
        <div>
            {
                sending ? (<button disabled type="button" className="w-full flex text-center py-2.5 px-5 me-2 mt-4 text-base font-medium rounded-lg border focus:z-10 focus:ring-4 focus:outline-none focus:ring-blue-700  bg-gray-800 text-gray-400 border-gray-600 justify-center items-center">
