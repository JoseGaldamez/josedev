...
export const ContactForm = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        // Aquí puedes manejar el envío del formulario, por ejemplo, enviarlo a una API o servicio de correo electrónico
        setIsLoading(true);
  ...
  return (  
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-xl mx-auto'>
        ...
        <button disabled={isLoading} type="submit" className='bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded-md transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed'>
