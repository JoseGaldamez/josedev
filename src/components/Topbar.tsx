    ...
    <div className='backdrop-blur-sm text-white p-4 w-full flex justify-between items-center fixed top-0 z-50'>
      ...
      <menu>
        <ul className='flex gap-4'>
          ...
          <li>
            <Link href="/about" className='text-white/40 hover:text-white/80 transition-colors duration-300 font-extralight'>
              <User2Icon size={22} className="inline mb-1 mr-1 font-extralight" />
            </Link>
          </li>
          <li>
            <Link href="/contact" className='text-white/40 hover:text-white/80 transition-colors duration-300 font-extralight'>
