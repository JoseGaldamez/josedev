...
export const metadata: Metadata = {
    title: 'José Galdámez | Frontend Developer',
    description: 'Desarrollador frontend con experiencia en diversas tecnologías y empresas.',
    openGraph: {
    ...
    alternates: {
        canonical: 'https://josegaldamez.dev/skills/frontend',
    }
};
