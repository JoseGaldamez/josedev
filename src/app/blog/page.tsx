    ...
    return (
        <>
            ...
            <div className="container max-w-5xl mx-auto px-4 py-24">
                <h1 className="text-4xl font-bold mb-8 text-[#061929]">Blog</h1>
                <div className="grid gap-8">
                    {posts.map((post) => (
                        <article key={post.slug} className="rounded-lg py-6 hover:bg-gray-100 hover:bg-opacity-10 flex flex-col md:flex-row gap-8">
                            ...
                            <div className='w-full md:w-2/3'>
                                ...
                                <Link href={`/blog/${post.slug}`}>
                                    <h3 className="text-2xl font-semibold mb-2 text-[#061929]">{post.title}</h3>
                                </Link>
