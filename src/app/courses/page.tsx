        ...
        <div>
            ...
            <div className="container max-w-4xl mx-auto px-4 py-24">
                ...
                <div className="border border-slate-500 border-dashed rounded-lg p-5 flex justify-between items-center">
                    <span>
                        Cupón de descuento para mis cursos: <span className="text-violet-800 font-bold">MAYO2025</span>
                    </span>
                    <span className="cursor-pointer text-slate-500 hover:text-slate-800 transition-colors flex items-center gap-2">
